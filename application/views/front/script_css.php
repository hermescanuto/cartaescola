        ...
        <![endif]-->
        <link rel="stylesheet" media="all" href="{base_url}css/style.css"/>
        <meta name="viewport" content="width=device-width, initial-scale=1"/>
        <!-- Adding "maximum-scale=1" fixes the Mobile Safari auto-zoom bug: http://filamentgroup.com/examples/iosScaleBug/ -->
        
        <link rel="icon" type="image/ico" href="{base_url}/img/animated_favicon1.gif"/>
        <link rel="shortcut icon" href="{base_url}/img/animated_favicon1.gif" />
        ...
        <!-- Tweet -->
        <link rel="stylesheet" href="{base_url}css/jquery.tweet.css" media="all"  /> 
        ...
        <script  src="{base_url}js/supersubs.js"></script>
        <!-- ENDS superfish -->
        ...
        <!-- poshytip -->
        <link rel="stylesheet" href="{base_url}css/tip-twitter.css"  />
        <link rel="stylesheet" href="{base_url}css/tip-yellowsimple.css"  />
        <script  src="{base_url}js/jquery.poshytip.min.js"></script>
        <!-- ENDS poshytip -->
        ...
        <!-- Less framework -->
        <link rel="stylesheet" media="all" href="{base_url}css/lessframework.css"/>
        
        <!-- modernizr -->
        <script src="{base_url}js/modernizr.js"></script>
       
        <!-- SKIN -->
        <link rel="stylesheet" media="all" href="{base_url}css/skin.css"/>