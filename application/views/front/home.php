			...
			<div class="wrapper">
				...
				<div id="slider-holder" class="clearfix">
					...
					<div class="flexslider home-slider">
						<ul class="slides">
							<li>
								<img src="{base_url}upload/{imagem_home0}" alt="{titulo0}" />
								<p class="flex-caption">
									<a href="{base_url}single/show/{destaque_id0}">{titulo0}</a>
								</p>
							</li>
							<li>
								<img src="{base_url}upload/{imagem_home1}" alt="{titulo1}" />
								<p class="flex-caption">
									<a href="{base_url}single/show/{destaque_id1}">{titulo1}</a>
								</p>
							</li>
							<li>
								<img src="{base_url}upload/{imagem_home2}" alt="{titulo2}" />
								<p class="flex-caption">
					...
					<div id="headline">
						<center>
							<p>
								<a href="{base_url}edicao/{edicao_numero}" class="opener"><img src="{base_url}/upload/capa/{edicao_capa}" alt="Capa {edicao_numero} abril Carta na Escola revista mensal" width="165" height="211" /></a>
							</p>
							<p>
								Edição N&deg;{edicao_numero}
							</p>
						</center>
					</div>
					<!-- ENDS headline -->
                ...
                <div class="home-block" >
					...
					<div class="one-third-thumbs clearfix" >
						...
						<figure>
							...
							<a href="{base_url}single/show/{id0}"  class="thumb"><img src="{base_url}upload/{imagem0}" alt="Alt text" /></a>
						</figure>
						...
						<figure>
							...
							<a href="{base_url}single/show/{id1}"  class="thumb"><img src="{base_url}upload/{imagem1}" alt="Alt text" /></a>
						</figure>
						...
						<figure>
							...
							<a href="{base_url}single/show/{id3}"  class="thumb"><img src="{base_url}upload/{imagem3}" alt="Alt text" /></a>
						</figure>
						...
						<figure>
							...
							<a href="{base_url}single/show/{id4}"  class="thumb"><img src="{base_url}upload/{imagem4}" alt="Alt text" /></a>
						</figure>
						...
						<figure class="last">
							...
							<a href="{base_url}single/show/{id5}"  class="thumb"><img src="{base_url}upload/{imagem5}" alt="Alt text" /></a>
						</figure>
					...
					<div class="one-fourth-thumbs clearfix">
						...
						<figure>
							<figcaption>
								...
								<span>Professor as matérias originalmente publicadas em CartaCapital estão disponíveis para seus alunos no site www.cartacapital.com.br.</span>
								<em>December 08, 2011</em>
								<a href="single.html" class="opener"></a>
							</figcaption>

							<a href="single.html"  class="thumb"><img src="{base_url}img/dummies/featured-7.jpg" alt="Alt text" /></a>
						</figure>
						...
						<figure>
							...
							<a href="single.html"  class="thumb"><img src="{base_url}img/dummies/featured-8.jpg" alt="Alt text" /></a>
						</figure>
						...
						<figure>
							...
							<a href="single.html"  class="thumb"><img src="{base_url}img/dummies/featured-9.jpg" alt="Alt text" /></a>
						</figure>

						<figure class="last">
							<figcaption>
								<strong>Língua Inglesa</strong>
								<span>Professor as matérias originalmente publicadas em CartaCapital estão disponíveis para seus alunos no site www.cartacapital.com.br.</span>
								<em>December 08, 2011</em>
								<a href="single.html" class="opener"></a>
							</figcaption>

							<a href="single.html"  class="thumb"><img src="{base_url}img/dummies/featured-10.jpg" alt="Alt text" /></a>
						</figure>
