			...
			<div class="wrapper clearfix">
			  ...
			  <h2 class="page-heading"><span>CONTATO</span></h2>	
				...
				<script type="text/javascript">
					function initialize() {
						var latlng = new google.maps.LatLng(-23.561329, -46.658321);
						var myOptions = {
						  zoom: 8,
						  center: latlng,
				...
				<!-- ENDS Map -->
					...
					<form id="contactForm" action="#" method="post">
						<h2 class="heading">Entre em contato conosco</h2>
						...
						<fieldset>
							...
							<p><input type="button" value="Enviar" name="submit" id="submit" /> 
							<span id="error" class="warning">Mensagem</span></p>
						</fieldset>
		        	...
		        	<aside id="contact-sidebar">
		        		<div class="block">
			        		...
			        		<p>Assinaturas, sugestões e reclamações</p>
			        		
			        		<ul class="address-block">
			        			<li class="address">Address line, city, state ZIP</li>
			        			<li class="phone">11 0800 707-0262</li>
			        			<li class="phone">11 3038-1477</li>
			        			<li class="phone">11 3038-4917</li>
			        			<li class="email"><a href="mailto:email@server.com">cartacapital@acsolucoes.com.br</a></li>
			        		</ul>
