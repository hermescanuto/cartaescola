		...
		<div id="main">	
			<div class="wrapper">
				...
				<div id="slider-holder" class="clearfix">
			        ...
			        <div class="flexslider home-slider">
					  <ul class="slides">
					    <li>
                          ...
                          <p class="flex-caption">Fatalidae ou crime?</p>
					    </li>
					    <li>
					      <img src="img/slides/02.jpg" alt="alt text" />
					      <p class="flex-caption">A Canção que não termina</p>
					    </li>
					    <li>
					      <img src="img/slides/03.jpg" alt="alt text" />
                          <p class="flex-caption">Juventude e trabalho</p>
					    </li>
					  </ul>
					</div>
		        	<!-- ENDS slider -->
		        	...
		        	<!-- Headline -->
		        	<div id="headline">
		        		<h1><a href="http://www.mercadocapital.com.br/ncartanaescola.html">ASSINE!</a></h1>
		        		<p>ATUALIDADES EM SALA DE AULA</p>
		        		<p>Fique por dentro dos últimos assuntos</p>
		        		<p>&nbsp;</p>
		        		<p>Visite o <a href="http://www.cartacapital.com.br">site</a> de CartaCapital</p>
		        		<p>Visite o <a href="http://www.cartacapital.com.br">site</a> de Carta Fundamental</p>
		        		<em id="corner"></em>
		        	</div>
		        	<!-- ENDS headline -->
	        	...
	        	<div class="home-block" >
	        		<h2 class="home-block-heading"><span>ATUALIDADES</span></h2>
